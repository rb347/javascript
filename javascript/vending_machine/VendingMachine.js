...
let VendingMachine = {
  ...
  items: {
    A1: { item_name: "Fruit Loops", price: 3.5 },
    A2: { item_name: "Yogurt", price: 1.5 },
    A3: { item_name: "Snickers", price: 1.75 },
    B1: { item_name: "M&M's", price: 0.25 },
    B2: { item_name: "Bubble Gum", price: 0.5 },
    B3: { item_name: "Orange", price: 1.15 },
    C1: { item_name: "Reeses Pieces", price: 1.0 },
    C2: { item_name: "Oreo", price: 1.2 },
    C3: { item_name: "Grapefruit", price: 2.5 },
  },
  money_in: 0,
